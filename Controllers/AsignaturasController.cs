...
namespace CFTRegistroDeNotas.Controllers
{
    public class AsignaturasController : Controller
    {
        ...
        public AsignaturasController(DbcftContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()                    
        {
              return _context.Asignaturas != null ? 
                          ...
                          Problem("Entity set 'DbcftContext.Asignaturas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Codigo,FechaCreacion")] Asignatura asignatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,Codigo,FechaCreacion")] Asignatura asignatura)
        {
            if (id != asignatura.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbcftContext.Asignaturas'  is null.");
            }
            var asignatura = await _context.Asignaturas.FindAsync(id);
            if (asignatura != null)
            {
